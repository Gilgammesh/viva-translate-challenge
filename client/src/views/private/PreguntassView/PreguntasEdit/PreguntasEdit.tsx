...
/*******************************************************************************************************/
// Definimos el componente Cuesionarios - Preguntas - Editar //
/*******************************************************************************************************/
const PreguntasEdit = () => {
	...
	const onSubmit = async (event: ChangeEvent<HTMLFormElement>) => {
		...
		if (await validateOpciones()) {
			...
			const result = await fetchData(`quiz/preguntas/${pregunta._id}`, 'PUT', {
				...formValues,
				opciones,
